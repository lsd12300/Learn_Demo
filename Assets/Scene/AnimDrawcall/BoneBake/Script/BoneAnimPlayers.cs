...
public class BoneAnimPlayers : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        _render[0].sharedMaterial.SetTexture("_BoneBake", _tex);
        _render[0].sharedMaterial.SetFloat("_BoneCount", _data.BoneCount);
